...
class BARTModel(TransformerModel):
    ...
    def forward(
        ...
        #assert 0, encoder_out['encoder_out_tokens'][0], 
        if self.args.e2s2_random == 0.0 and self.args.e2s2_shuffle == 0.0:
            return x, extra, encoder_out['encoder_out'][0]
        else:
            return x, extra, encoder_out['encoder_out_tokens'][0], encoder_out['encoder_out'][0]
